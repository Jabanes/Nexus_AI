"""
Gemini LLM Provider — Google Gemini API via the google-genai SDK.

Implements ILLMProvider for the Google Gemini model family.
...
class GeminiProvider(ILLMProvider):
    ...
    def create_chat_session(
        ...
        Returns:
            A Chat object from the google-genai SDK
        """
    ...
    ) -> Optional[List[types.FunctionDeclaration]]:
